...
//       {/* Hero Section */}
//       <section className="py-20 px-5 md:px-20 text-center bg-gradient-to-r from-pink-100 via-purple-100 to-blue-100">
//         <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-5">
//           Build Your Ultimate AI-Powered Resume
//         </h1>
//         <p className="text-lg text-gray-600 mb-10 max-w-2xl mx-auto">
//           Generate professional resumes using AI ✨ — with live previews, theme customization, and smart suggestions.
//         </p>
...
//           <div className="p-6 shadow-lg rounded-xl border border-gray-200">
//             <h3 className="font-bold mb-2 text-lg">AI-Powered Summary</h3>
//             <p className="text-gray-500 text-sm">Let Gemini suggest professional summaries based on your role.</p>
//           </div>
//           <div className="p-6 shadow-lg rounded-xl border border-gray-200">
//             <h3 className="font-bold mb-2 text-lg">Live Resume Preview</h3>
//             <p className="text-gray-500 text-sm">Instantly see how your resume will look — as you build it.</p>
//           </div>
//           <div className="p-6 shadow-lg rounded-xl border border-gray-200">
//             <h3 className="font-bold mb-2 text-lg">Custom Themes</h3>
//             <p className="text-gray-500 text-sm">Choose your color and make your resume stand out.</p>
//           </div>
//         </div>
//       </section>

//       {/* Footer */}
//       <footer className="text-center py-6 text-gray-400 text-sm border-t mt-20">
//         Made with 💜 by Aashi
//       </footer>
//     </div>
//   )
